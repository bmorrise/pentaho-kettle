...
public interface FileProvider {
  ...
  Result renameFile( String path, String newPath, boolean overwrite, Properties properties );

  Result copyFile( String path, String newPath, boolean overwrite, Properties properties );

  Result fileExists( String path, Properties properties );
  ...
  boolean isSame( String provider, Properties properties );

  Result getNewName( String path, Properties properties );
}
