...
public class VFSConnectionTreeDelegateExtension implements ExtensionPointInterface {

  public VFSConnectionTreeDelegateExtension() {
  ...
  @Override public void callExtensionPoint( LogChannelInterface log, Object extension ) throws KettleException {
    ...
    if ( path[2].equals( VFSConnectionFolderProvider.STRING_VFS_CONNECTIONS ) ) {
      switch ( caseNumber ) {
        case 3:
