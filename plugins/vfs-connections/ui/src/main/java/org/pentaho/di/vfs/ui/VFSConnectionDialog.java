 ...
 */
public class VFSConnectionDialog extends ThinDialog {
  ...
  public VFSConnectionDialog( Shell shell, int width, int height ) {
  ...
  private static String getClientPath() {
    ...
    try {
      InputStream inputStream = VFSConnectionDialog.class.getClassLoader().getResourceAsStream( "project.properties" );
